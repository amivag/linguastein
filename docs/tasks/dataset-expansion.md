...
**Re-measured 2026-08-24**, against pack `0.6.0`. Goals 2 and 3 of §5 have since
...
| Measure                              | Now                                    |
| ------------------------------------ | -------------------------------------- |
| Practisable items                    | 2,205                                  |
| — sentences and phrases              | 1,577                                  |
| — word cards                         | 628                                    |
...
| Running words of Spanish             | **8,900 (~74 minutes of reading)**     |
| Average sentence length              | 5.6 words                              |
| Longest single item                  | 13 words                               |
| Multi-sentence texts                 | **87 (37 texts, 50 dialogues)**        |
| — sentences read in context          | 659, averaging 7.6 per passage         |
| Tokens linked to a lexeme            | 8,866 of 8,900 (100%)                  |
| Lexemes appearing in ≥1 sentence     | 781 of 803                             |
| Lexemes appearing in exactly one     | **132 (16%)**                          |
| Lexemes with ≥6 encounters           | **266 (33%)**                          |
| Questions / statements               | 391 / 1,034, with **5** minimal pairs  |
| Items marked with register           | 907                                    |
| Items marked with address (tú/usted) | 443                                    |
| Items marked with a region           | 56                                     |
| Items containing `¡`                 | 14                                     |
| Items with audio                     | 0                                      |
| Senses                               | 0                                      |
...
Measured cost of what remains: **1,555 missing encounters**, which at 5.6 linked
words per sentence is **277 more sentences at an absolute minimum**, and only if
...
**This is the part that is now done.** 8,900 running words is about an hour of
...
- **Usage marking**: 907 items of 1,577 carry register and 443 carry address, up
...
- **Exclamations**: 14 items of 2,205 contain `¡` — up from zero, and still
...
1. **Recycling — the content half is still open; the gate is not.** Every A1
   ...
   Currently **374 of 624** A1 lexemes and **103 of 179** A2 lexemes are short.
   ...
   unrecorded. Turning the real threshold on today would fail the build on 374
...
2. ~~**Volume.**~~ **Done** — 1,577 sentences and 8,900 running words, against a
   target of 1,200–1,500 and 8,000–10,000. About an hour of material.
3. ~~**Extended input.**~~ **Done and past the target** — 87 passages averaging
...
- [x] 1,200+ sentences, 8,000+ running words — 1,577 sentences, 8,900 words
