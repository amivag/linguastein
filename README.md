...
in place, with a generated A1–A2 Spanish pack of 1,049 practisable items awaiting
...
| Browse   | search and filter all 1,049 items, by thematic category or facet; dictate the search with the mic |
...
**358 nouns**, **218 modifiers** and **598 example sentences** — 1,049 practisable
items in total.
