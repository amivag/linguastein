 ...
 * touching the session planner, the UI or the stored shape of `SubjectProgress`.
 *
...
import type { SubjectProgress, ReviewGrade, Timestamp } from './types';

export interface Scheduler {
  readonly id: string;
  review(progress: SubjectProgress, grade: ReviewGrade, now: Timestamp): SubjectProgress;
}
