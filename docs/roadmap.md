...
- core-es pack: 126 verbs (3,024 generated forms), 392 nouns, 277 modifiers,
  1,228 sentences — 1,854 practisable items, 99% of sentence words linked to a lexeme
...
0. **Editorial review of core-es** — the pack is machine-generated and marked
   ...
   reading all 1,854 at once, and `npm run review:data` reports the rows worth
