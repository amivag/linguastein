...
in place, with a generated A1–A2 Spanish pack of 1,688 practisable items awaiting
...
search and filter all 1,688 items by category or facet (and dictate the search
...
**390 nouns**, **276 modifiers** and **1,065 example sentences** — 1,688 practisable
items in total.
