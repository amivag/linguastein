...
in place, with a generated A1–B1 Spanish pack of 3,045 practisable items awaiting
...
search and filter all 3,045 items by category or facet (and dictate the search
...
**467 nouns**, **314 modifiers** and **2,268 example sentences** — 3,045 practisable
items in total.
