...
in place, with a generated A1–B1 Spanish pack of 3,127 practisable items awaiting
...
search and filter all 3,127 items by category or facet (and dictate the search
...
The shipped `core-es` pack covers A1–B1: **175 verbs** with generated forms,
**467 nouns**, **314 modifiers** and **2,350 example sentences** — 3,127 practisable
items in total.
