...
in place, with a generated A1–A2 Spanish pack of 1,854 practisable items awaiting
...
search and filter all 1,854 items by category or facet (and dictate the search
...
**392 nouns**, **277 modifiers** and **1,228 example sentences** — 1,854 practisable
items in total.
