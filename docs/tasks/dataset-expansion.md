...
| Measure                              | Now                                    |
| ------------------------------------ | -------------------------------------- |
| Practisable items                    | 2,142                                  |
| — sentences and phrases              | 1,514                                  |
| — word cards                         | 628                                    |
...
| Running words of Spanish             | **8,385 (~70 minutes of reading)**     |
| Average sentence length              | 5.5 words                              |
| Longest single item                  | 13 words                               |
| Multi-sentence texts                 | **79 (29 texts, 50 dialogues)**        |
| — sentences read in context          | 596, averaging 7.5 per passage         |
| Tokens linked to a lexeme            | 8,352 of 8,385 (100%)                  |
| Lexemes appearing in ≥1 sentence     | 781 of 803                             |
| Lexemes appearing in exactly one     | **161 (20%)**                          |
| Lexemes with ≥6 encounters           | **251 (31%)**                          |
| Questions / statements               | 391 / 1,034, with **5** minimal pairs  |
| Items marked with register           | 844                                    |
...
**This is the part that is now done.** 8,385 running words is about an hour of
...
- **Usage marking**: 844 items of 1,514 carry register and 443 carry address, up
...
- **Exclamations**: 14 items of 2,142 contain `¡` — up from zero, and still
...
1. **Recycling — the content half is still open; the gate is not.** Every A1
   ...
   Currently **384 of 624** A1 lexemes and **139 of 179** A2 lexemes are short.
   ...
   unrecorded. Turning the real threshold on today would fail the build on 384
...
2. ~~**Volume.**~~ **Done** — 1,514 sentences and 8,385 running words, against a
   target of 1,200–1,500 and 8,000–10,000. About an hour of material.
3. ~~**Extended input.**~~ **Done and past the target** — 79 passages averaging
   7.5 sentences, against 30–60. Per §3.2 this was also meant to be the cheapest
...
- [x] 1,200+ sentences, 8,000+ running words — 1,514 sentences, 8,385 words
